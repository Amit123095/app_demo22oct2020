 ...
 */
public class DownloadHistoryTask extends AsyncTask<String, Void, File> {
    ...
    public DownloadHistoryTask(Context context, DbxClientV2 dbxClient, Callback callback) {
        mContext = context;
    ...
    protected File doInBackground(String... params) {
        ...
        try {
            ...
            try (OutputStream outputStream = new FileOutputStream(file)) {
                mDbxClient.files().download(metadata, rev)
